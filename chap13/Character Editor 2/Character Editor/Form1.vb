...
Public Class Form1
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, _
        ...
        REM add item list to "drop item" combos
        Dim items As New Items()
        If Not items.Load("items.item") Then
            MessageBox.Show("Error loading items.item")
            End
        End If

        For Each it As Item In items.items
            cboDrop1.Items.Add(it.ToString())
            cboDrop2.Items.Add(it.ToString())
            cboDrop3.Items.Add(it.ToString())
        Next
    ...
    Private Sub loadFile(ByVal filename As String)
        Try
            ...
            numWidth.Value = Convert.ToInt32(getElement("anim_walk_width", element))
            numHeight.Value = Convert.ToInt32(getElement("anim_walk_height", element))
            numColumns.Value = Convert.ToInt32(getElement("anim_walk_columns", element))
            txtAttackFile.Text = getElement("anim_attack_filename", element)
            numWidth2.Value = Convert.ToInt32(getElement("anim_attack_width", element))
            numHeight2.Value = Convert.ToInt32(getElement("anim_attack_height", element))
            numColumns2.Value = Convert.ToInt32(getElement("anim_attack_columns", element))
            txtDieFile.Text = getElement("anim_die_filename", element)
            numWidth3.Value = Convert.ToInt32(getElement("anim_die_width", element))
            numHeight3.Value = Convert.ToInt32(getElement("anim_die_height", element))
            numColumns3.Value = Convert.ToInt32(getElement("anim_die_columns", element))
            numGold1.Value = Convert.ToInt32(getElement("dropgold1", element))
            numGold2.Value = Convert.ToInt32(getElement("dropgold2", element))
            numDrop1.Value = Convert.ToInt32(getElement("drop1_num", element))
            numDrop2.Value = Convert.ToInt32(getElement("drop2_num", element))
            numDrop3.Value = Convert.ToInt32(getElement("drop3_num", element))
            cboDrop1.Text = getElement("drop1_item", element)
            cboDrop2.Text = getElement("drop2_item", element)
            cboDrop3.Text = getElement("drop3_item", element)
    ...
    Private Sub saveFile(ByVal filename As String)
        Try
            ...
            table.Columns.Add(New DataColumn("desc", typeStr))
            table.Columns.Add(New DataColumn("str", typeStr))
            ...
            table.Columns.Add(New DataColumn("hitpoints", typeInt))
            table.Columns.Add(New DataColumn("anim_walk_filename", typeStr))
            table.Columns.Add(New DataColumn("anim_walk_width", typeInt))
            table.Columns.Add(New DataColumn("anim_walk_height", typeInt))
            table.Columns.Add(New DataColumn("anim_walk_columns", typeInt))
            table.Columns.Add(New DataColumn("anim_attack_filename", typeStr))
            table.Columns.Add(New DataColumn("anim_attack_width", typeInt))
            table.Columns.Add(New DataColumn("anim_attack_height", typeInt))
            table.Columns.Add(New DataColumn("anim_attack_columns", typeInt))
            table.Columns.Add(New DataColumn("anim_die_filename", typeStr))
            table.Columns.Add(New DataColumn("anim_die_width", typeInt))
            table.Columns.Add(New DataColumn("anim_die_height", typeInt))
            table.Columns.Add(New DataColumn("anim_die_columns", typeInt))
            table.Columns.Add(New DataColumn("dropgold1", typeInt))
            table.Columns.Add(New DataColumn("dropgold2", typeInt))
            table.Columns.Add(New DataColumn("drop1_num", typeInt))
            table.Columns.Add(New DataColumn("drop2_num", typeInt))
            table.Columns.Add(New DataColumn("drop3_num", typeInt))
            table.Columns.Add(New DataColumn("drop1_item", typeStr))
            table.Columns.Add(New DataColumn("drop2_item", typeStr))
            table.Columns.Add(New DataColumn("drop3_item", typeStr))
            ...
            row("drop1_num") = numDrop1.Value
            row("drop2_num") = numDrop2.Value
            row("drop3_num") = numDrop3.Value
            row("drop1_item") = cboDrop1.Text
            row("drop2_item") = cboDrop2.Text
            row("drop3_item") = cboDrop3.Text
            table.Rows.Add(row)
